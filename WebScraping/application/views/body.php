  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Agus H. Abadi</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Scrap</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Scrap v2</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header no-border">
                <h3 class="card-title">Scrap</h3>
                <div class="card-tools">
                  <!-- <a href="#" class="btn btn-tool btn-sm">
                    <i class="fa fa-download"></i>
                  </a> -->
                  <div class="input input-group input-group-sm">
                    <div class="col-xs-6" id="div-inp-scraping-search"> 
                      <input type="search" class="form-control" placeholder="Search" aria-label="search" id="inp-scraping-search">
                    </div>
                    <div class="input-group-append">
                      <button class="btn btn-navbar" id="btn-scraping-search">
                        <i class="fa fa-search"></i>
                      </button>
                    </div>
                  </div>
              ...
              <div class="card-body">
                <table class="table table-striped table-valign-middle" id="table-scrap-result">
                  <thead>
                    <tr>
                      <th>Title</th>
                      <th>Meta title</th>
                ...
                <div class="d-flex flex-row justify-content-end">
                  <span class="mr-2">
                    <ul class="pagination pagination-sm" id="pagination-scrap">
